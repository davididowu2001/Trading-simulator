...
export default function Auth() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.token) {
        ...
        // Display backend error or a generic one
  ...
  return (
    /* Full-screen wrapper to perfectly center the login card */
    <div style={{ 
      display: 'flex', 
      ...
      {/* Reusing the trade-panel class for that nice dark card look */}
      <div className="trade-panel" style={{ width: '100%', maxWidth: '420px', margin: '20px', padding: '40px' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <button type="submit" style={{ width: '100%', marginTop: '10px', padding: '14px', fontSize: '16px' }}>
